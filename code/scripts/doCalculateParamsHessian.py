...
def main(argv):
    ...
    hessian = jax.hessian(inferenceOptimFunc)(params)

    results = dict(params=params, hessian=hessian)

    with open(hessian_filename, "wb") as f: pickle.dump(results, f)

    print(f"Saved {hessian_filename}")
