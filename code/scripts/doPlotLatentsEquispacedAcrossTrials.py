...
def main(argv):
    ...
    parser.add_argument("--latent_to_plot", help="trial to plot", type=int,
                        default=0)
    parser.add_argument("--latents_to_2D_plot",
                        help="latents to plot in 2D plot",
                        type=str, default="[0,1]")
    parser.add_argument("--latents_to_3D_plot",
                        help="latents to plot in 3D plot",
    ...
    parser.add_argument("--latents_fig_filename_pattern",
                        ...
                        default="../../figures/EJT178_implant1/recording6_29-03-2022/{:08d}_equispaced_latent{:03d}.{{:s}}")
    parser.add_argument("--ortonormalized_latent_mean_fig_filename_pattern",
                        help="orthonormalized latent mean figure filename pattern", type=str,
                        default="../../figures/EJT178_implant1/recording6_29-03-2022/{:08d}_orthonormalized_equispaced_latent_mean{:03d}.{{:s}}")
    ...
    ortonormalized_latent_mean_fig_filename_pattern = args.ortonormalized_latent_mean_fig_filename_pattern.format(est_res_number, latent_to_plot)
    ...
    # l_means[r] \in n_latents x n_times[r]
    ...
    fig = svGPFA.plot.plotUtilsPlotly.getPlotEquispacedLatentMeanAcrossTrials(
        times=trials_times,
    ...
    fig = svGPFA.plot.plotUtilsPlotly.getPlotOrthonormalizedLatentMeanAcrossTrials(
        times=trials_times, latentsMeans=l_means,
        C=C, trials_ids=trials_ids,
        latentToPlot=latent_to_plot,
        align_event_times=align_event_times,
        events_names=events_names,
        marked_events_times=marked_events_times,
...
#         trials_annotations=trials_annotations,
        xlabel="Time (sec)")
    fig.update_layout(title=title)
    fig.write_image(ortonormalized_latent_mean_fig_filename_pattern.format("png"))
    fig.write_html(ortonormalized_latent_mean_fig_filename_pattern.format("html"))
