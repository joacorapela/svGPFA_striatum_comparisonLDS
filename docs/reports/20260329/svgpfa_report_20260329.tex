...
\begin{figure}
    ...
    trials used to estimate the svGPFA mdoel parameters (i.e., trials 42-141).
    %
...
\begin{figure}
    ...
    \href{http://www.gatsby.ucl.ac.uk/~rapela/emmett/reports/svgpfa_20260307/figures/99226606_orthonormalized_nonEpoched_latents.html}{\includegraphics[width=6in]{../../../figures/EJT178_implant1/recording6_29-03-2022/99226606_orthonormalized_nonEpoched_latents.png}}
    \caption{Orthonormalised latent variables inferred from data in a
    non-behavioral block immediately following behavior.}
...
\begin{figure}
    ...
    \href{http://www.gatsby.ucl.ac.uk/~rapela/emmett/reports/svgpfa_20260307/figures/train54368807_test99226606_inferred_hmm_most_prob_state_seq.html}{\includegraphics[width=6in]{../../../figures/EJT178_implant1/recording6_29-03-2022/train54368807_test99226606_inferred_hmm_most_prob_state_seq.png}}
