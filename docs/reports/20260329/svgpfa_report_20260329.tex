...
\begin{figure}
    ...
    non-behavioral period between 6,000 and 6,400 seconds.}
...
\begin{figure}
    ...
    \caption{Inferred behavioral states, when
...
\begin{figure}
    ...
    \href{http://www.gatsby.ucl.ac.uk/~rapela/emmett/reports/svgpfa_20260307/figures/91676545_orthonormalized_nonEpoched_latents.html}{\includegraphics[width=6in]{../../../figures/EJT178_implant1/recording6_29-03-2022/91676545_orthonormalized_nonEpoched_latents.png}}
    \caption{Orthonormalised latent variables inferred from shuffled data in a
    non-behavioral period between 6,000 and 6,400 seconds.}

    \label{fig:inferredLatentsTestDuringShuffledPostBehavior6000_6400}
\end{figure}

\begin{figure}
    \centering

    \href{http://www.gatsby.ucl.ac.uk/~rapela/emmett/reports/svgpfa_20260307/figures/train54368807_test91676545_inferred_hmm_most_prob_state_seq.html}{\includegraphics[width=6in]{../../../figures/EJT178_implant1/recording6_29-03-2022/train54368807_test91676545_inferred_hmm_most_prob_state_seq.png}}

    \caption{Inferred behavioral states, when estimation was done with data in
    the behavioral period and inference was done with shuffled data in a
    non-behavioral period between 6,000 and 6,400 seconds. Note that the
    ordered progressions from states 1-10 between 6000 and 6074~sec observed in
    Fig.~\ref{fig:trueVsInferredStatesTest6000_6400} is not present in this
    figure. Also, the rhythmic repetition of state 9 between 6290 and 6300~sec
    observed in Fig.~\ref{fig:trueVsInferredStatesTest6000_6400} is not present
    here.}

    \label{fig:trueVsInferredStatesShuffledTest6000_6400}
\end{figure}
...
\begin{figure}
    ...
    \caption{Orthonormalised latent variables inferred from data in a
    non-behavioral period between 6,400 and 6,800 seconds.}
...
\begin{figure}
    ...
    \caption{Orthonormalised latent variables inferred from data in a
    non-behavioral period between 6,800 and 7,200 seconds.}
...
\begin{figure}
    ...
    \caption{Inferred behavioral states, when estimation was done with data in
    the behavioral period and inference was done with data in a non-behavioral
    period between 6,800 and 7,200 seconds.}
...
\begin{figure}
    ...
    \href{http://www.gatsby.ucl.ac.uk/~rapela/emmett/reports/svgpfa_20260307/figures/84848570_orthonormalized_nonEpoched_latents.html}{\includegraphics[width=6in]{../../../figures/EJT178_implant1/recording6_29-03-2022/84848570_orthonormalized_nonEpoched_latents.png}}
    \caption{Orthonormalised latent variables inferred from shuffled data in a
    non-behavioral period between 6,800 and 7,200 seconds.}

    \label{fig:inferredLatentsTestDuringPostBehaviorShuffled6800_7200}
\end{figure}
...
\begin{figure}
    ...
    \href{http://www.gatsby.ucl.ac.uk/~rapela/emmett/reports/svgpfa_20260307/figures/88250367_hmm_most_prob_state_seq.html}{\includegraphics[width=6in]{../../../figures/EJT178_implant1/recording6_29-03-2022/83727406_hmm_most_prob_state_seq.png}}

    \caption{Inferred behavioral states, when
    estimation was done with data in the behavioral period and inference was
    done with shuffled data in a non-behavioral period between 6,400 and 6,800 seconds.}

    \label{fig:trueVsInferredStatesShuffledTest6400_6800}
\end{figure}
\end{comment}
...
\begin{figure}
    ...
    \caption{Orthonormalised latent variables inferred from data in a
    non-behavioral period between 7,200 and 7,600 seconds.}
...
\begin{figure}
    ...
    \caption{Inferred behavioral states, when estimation was done with data in
    the behavioral period and inference was done with data in a non-behavioral
    period between 7,200 and 7,600 seconds.}
